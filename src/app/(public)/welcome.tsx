...
const bgImg = require("../../../assets/images/welcome-background.png");
const logo = require("../../../assets/images/logo.png");
const mockup = require("../../../assets/images/app-mockup.png");
    ...
    <ImageBackground className="flex-1" resizeMode="cover" source={bgImg}>
      ...
      <SafeAreaView className="flex-1">
        ...
        >
          ...
          <View className="relative -mt-2 h-[360px] flex-grow items-center overflow-hidden">
            <Image
